...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        clickAddNewContact();
        inputContactInformation(new ContactInformation("Alex", "Javov", "89876543210", "anemail@mail.com", "Any Town, Any Street, Any number house"));
    ...
    private void submitContactInformation() {
        wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
    }

    private void inputContactInformation(ContactInformation contactInformation) {
